...
namespace HeathenEngineering.Tools
{
    ...
    [AddComponentMenu("Heathen/Application/Unity TextMesh Pro String Field")]
    public class UnityTextMeshProStringField : MonoBehaviour
    {
        ...
        {
            var tField = GetComponent<TMPro.TextMeshProUGUI>();
